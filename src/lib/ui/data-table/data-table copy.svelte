...
<div class="grid h-inner-section grid-rows-[auto_auto_1fr_auto] space-y-gap-y">
	...
	<div class="-mr-gap min-h-0 overflow-y-auto pr-gap">
		<table class="">
			<thead class="bg-bg sticky top-0 z-10 border-b">
				<tr class="border-b">
					<th>
			...
			<tbody>
				{#each records as row}
					<tr
						onclick={() => editor.open({ type: 'update', collection, target: row })}
