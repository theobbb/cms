<script lang="ts">
	...
	$inspect(showCalendar);
</script>

<svelte:window onclick={handleOutsideClick} />

<div bind:this={containerRef} class="relative inline-block bg-surface text-surface-foreground">
	<Input
		{id}
		{name}
		value={inputValue}
	...
	{#if showCalendar}
		<div class="absolute z-50 mt-2 w-68 border bg-surface p-4">
